...
import { groomNameFirst, primaryEventForSide } from "../lib/invitationView";
...
export default function Hero({
  ...
  const firstName = groomFirst ? content.couple.groomName : content.couple.brideName;
  const secondName = groomFirst ? content.couple.brideName : content.couple.groomName;
